  ...
  return(
    <div className='NavBar'>
      <header className="bg-indigo-300 h-40 flex flex-col justify-center">
        ...
        <nav className="m-4">
          <NavLink className="border-black border-4 rounded-lg py-1 px-4 bg-indigo-500/75 hover:opacity-75 m-2" to='/'>Home</NavLink>
          <NavLink className="border-black border-4 rounded-lg py-1 px-4 bg-indigo-500/75 hover:opacity-75 m-2" to='/select-image'>Select</NavLink>
